"""
Unit tests for commands/push.py
"""
import argparse
import mock
import json
...
class TestGetRepoCommand(unittest.TestCase):
    """
    Tests for pyghub.commands.push command
    """
    def setup(self):
        pass
    ...
    def test_register_subparser(self):
        ...
        pyghub.commands.push.register_subparser(subparser)

        subparser.add_parser.assert_called_once_with("push", help=mock.ANY)
        ...
        subparser.set_defaults.assert_called_once_with(func=pyghub.commands.push.execute_command)
    ...
    def test_execute_command_with_valid_args_succeeds(self, mock_init, mock_path_exists):
        ...
        result = pyghub.commands.push.execute_command(input_args)
